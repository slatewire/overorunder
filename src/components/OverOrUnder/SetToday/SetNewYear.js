...
handleStartNewYear (habit) {
  ...
  render() {
    return (
      ...
      <p>thank you for playing OverOrUnder during 2018, all the feedback and ideas have been much appreciated. Early in 2019 I hope to take it into Beta along with a few additional features, such as a leaderboard so that you can gauge how you are doing compared to the rest of the community. All continued feedback will be really valuable... so, click below to start your 2019 habit changing journey. </p>
